...
public class MovieMain {
    ...
    private final static String TOP_GENRE = "TOP_GENRE";
    ...
    private void processTopGenre(int num, String type, String genre) {
        Map<String, List<Movie>> movies = this.imdb.getMoviesTopRatedByGenre(num, type, genre);
    ...
    public void mainLoop() {
        ...
        while (in.hasNext()) {
            ...
            switch (fields[0]) {
                ...
                case TOP_GENRE -> processTopGenre(Integer.parseInt(fields[1]), fields[2], fields[3]);
