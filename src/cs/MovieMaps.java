 ...
 * <br>
 * MovieMaps.GENRES.get("Action");   // returns Genre.ACTION<br>
 * MovieMaps.TITLE_TYPES.get("movie");   // returns TitleType.MOVIE<br>
 */
public final class MovieMaps {
    ...
    public final static Map<String, TitleType> TITLE_TYPES = Map.ofEntries(
            ...
            new AbstractMap.SimpleEntry<>("tvPilot", TitleType.TV_PILOT),
